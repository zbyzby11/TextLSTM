...
class InputData(object):
    def __init__(self, review_file, label_file, max_length=500):
        ...
        self.LABEL = data.Field(sequential=False, use_vocab=True, batch_first=True, unk_token=None)
...
def main():
    ...
    train_iter, val_iter, test_iter, voca = data.create_iter(split_ratio=[0.8, 0.1, 0.1], batch_size=500)
